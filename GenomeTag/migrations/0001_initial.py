# Generated by Django 5.0 on 2024-02-27 15:53
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "status",
                    models.CharField(
                        choices=[("u", "unreviewed"), ("r", "rejected"), ("v", "validated")], default="u", max_length=1
                    ),
                ),
                ("commentary", models.TextField(default="")),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "role",
                    models.CharField(
                        choices=[("v", "viewer"), ("a", "annotator"), ("r", "reviewer")], default="v", max_length=9
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "new_role",
                    models.CharField(choices=[("v", "viewer"), ("a", "annotator"), ("r", "reviewer")], max_length=9),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("posted_date", models.DateField(default=django.utils.timezone.now)),
                ("Topic", models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to="GenomeTag.topic")),
                (
                    "Author",
                    models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to=settings.AUTH_USER_MODEL),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "requester",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, related_name="planner", to=settings.AUTH_USER_MODEL
                    ),
                ),
            ],
        ),
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                null=True, on_delete=django.db.models.deletion.SET_NULL, related_name="reviewer", to=settings.AUTH_USER_MODEL
            ),
        ),
    ]
